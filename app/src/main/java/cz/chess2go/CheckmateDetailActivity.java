...
public class CheckmateDetailActivity extends AppCompatActivity {

    private List<Integer> imageResIds;
    private int currentIndex = 0;
    private ImageView checkmateImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checkmate_detail);
        ...
        checkmateImage = findViewById(R.id.checkmateImage);
        TextView checkmateTitle = findViewById(R.id.checkmateTitle);
        TextView checkmateDescription = findViewById(R.id.checkmateDescription);
        ...
        checkmateTitle.setText(title);
        checkmateDescription.setText(description);
    ...
    private void updateImage() {
        checkmateImage.setImageResource(imageResIds.get(currentIndex));
    }
    ...
    public void backToCheckmates(View view) {
        Intent intent = new Intent(this, CheckmatesMenuActivity.class);
